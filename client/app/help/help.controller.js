...
angular.module('boardOsApp')
  .controller('helpCtrl', function($scope, $rootScope, Auth, $http, actionKPI, categoryKPI, groupByKPI, metricTaskFields, listValuesKPI, $stateParams, myLibrary, $location, Notification) {
