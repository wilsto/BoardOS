...
angular.module('boardOsApp').controller('ObeyaCtrl', function($scope, $http, Notification, $stateParams, $rootScope, dateRangeService, VisDataSet, $timeout, Milestones, Tasks, generator) {
  ...
  $scope.addWidget = function() {
    $scope.dashboard.widgets.push({name: 'New Widget', sizeX: 1, sizeY: 1});
  };
